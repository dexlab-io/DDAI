...
public static async deployFrom0xArtifactAsync(
        ...
        return BuyEthRecipeContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _token,
_underlying,
_kyberNetwork
);
    }
...
_kyberNetwork
        ...
        logUtils.log(`BuyEthRecipe successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new BuyEthRecipeContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
...
_kyberNetwork
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: { [contractName: string]: ContractAbi }) {
        super('BuyEthRecipe', BuyEthRecipeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies);

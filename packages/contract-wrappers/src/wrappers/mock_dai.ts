...
export class MockDaiContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return MockDaiContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        const contractInstance = new MockDaiContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
        contractInstance.constructorArgs = [];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, provider: Provider, txDefaults?: Partial<TxData>) {
        super('MockDai', abi, address, provider, txDefaults);

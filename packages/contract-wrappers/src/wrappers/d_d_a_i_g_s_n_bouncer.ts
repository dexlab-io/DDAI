...
export class DDAIGSNBouncerContract extends BaseContract {
    ...
    public accountDataOf = {
        async callAsync(
            ...
            callData: Partial<CallData> = {},
            defaultBlock?: BlockParam,
        ): Promise<[BigNumber, BigNumber, BigNumber, boolean, boolean]
        > {
            const self = this as any as DDAIGSNBouncerContract;
            ...
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<[BigNumber, BigNumber, BigNumber, boolean, boolean]
        >(rawCallResult);
            // tslint:enable boolean-naming
            return result;
        },
    ...
    public mintAndDistribute = {
        async sendTransactionAsync(
            ...
            const self = this as any as DDAIGSNBouncerContract;
            const encodedData = self._strictEncodeArguments('mintAndDistribute(address,uint256)', [_receiver,
    _amount
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                ...
                self._web3Wrapper.getContractDefaults(),
                self.mintAndDistribute.estimateGasAsync.bind(
                    self,
                    _receiver,
                    _amount
                ),
    ...
    _amount
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as DDAIGSNBouncerContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('mintAndDistribute(address,uint256)', [_receiver,
    _amount
    ]);
            return abiEncodedTransactionData;
        },
        ...
        _amount
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('mintAndDistribute(address,uint256)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<void
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    public mintAndSetRecipes = {
        async sendTransactionAsync(
            ...
            const self = this as any as DDAIGSNBouncerContract;
            const encodedData = self._strictEncodeArguments('mintAndSetRecipes(uint256,address[],uint256[],bytes[])', [_amount,
    _receivers,
    _ratios,
    _data
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                self.mintAndSetRecipes.estimateGasAsync.bind(
                    self,
                    _amount,
                    _receivers,
                    _ratios,
    ...
    _data
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as DDAIGSNBouncerContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('mintAndSetRecipes(uint256,address[],uint256[],bytes[])', [_amount,
    _receivers,
    _ratios,
    _data
    ]);
        ...
        _data
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('mintAndSetRecipes(uint256,address[],uint256[],bytes[])');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<void
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    public setAndDistributeStack = {
        async sendTransactionAsync(
            ...
            const self = this as any as DDAIGSNBouncerContract;
            const encodedData = self._strictEncodeArguments('setAndDistributeStack(address,uint256)', [_account,
    _amount
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                ...
                self._web3Wrapper.getContractDefaults(),
                self.setAndDistributeStack.estimateGasAsync.bind(
                    self,
                    _account,
                    _amount
                ),
    ...
    _amount
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as DDAIGSNBouncerContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setAndDistributeStack(address,uint256)', [_account,
    _amount
    ]);
            return abiEncodedTransactionData;
        },
        ...
        _amount
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('setAndDistributeStack(address,uint256)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<void
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    public setReceiveToStack = {
        async sendTransactionAsync(
            _value: boolean,
            txData: Partial<TxData> = {},
        ): Promise<string> {
            const self = this as any as DDAIGSNBouncerContract;
            const encodedData = self._strictEncodeArguments('setReceiveToStack(bool)', [_value
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
                ...
                self._web3Wrapper.getContractDefaults(),
                self.setReceiveToStack.estimateGasAsync.bind(
                    self,
                    _value
                ),
            );
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as DDAIGSNBouncerContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setReceiveToStack(bool)', [_value
    ]);
            return abiEncodedTransactionData;
        },
        async callAsync(
        ...
        > {
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('setReceiveToStack(bool)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<void
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    public setStackInterest = {
        async sendTransactionAsync(
            _value: boolean,
            txData: Partial<TxData> = {},
        ): Promise<string> {
            const self = this as any as DDAIGSNBouncerContract;
            const encodedData = self._strictEncodeArguments('setStackInterest(bool)', [_value
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
                ...
                self._web3Wrapper.getContractDefaults(),
                self.setStackInterest.estimateGasAsync.bind(
                    self,
                    _value
                ),
            );
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as DDAIGSNBouncerContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setStackInterest(bool)', [_value
    ]);
            return abiEncodedTransactionData;
        },
        async callAsync(
        ...
        > {
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('setStackInterest(bool)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<void
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    public withdrawEther = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                self.withdrawEther.estimateGasAsync.bind(
                    self,
                    _amount
                ),
            );

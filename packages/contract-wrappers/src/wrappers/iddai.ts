...
export class IDDAIContract extends BaseContract {
    public  = {
        async sendTransactionAsync(
            ...
            const encodedData = self._strictEncodeArguments('burn(address,address)', [_receiver,
    _amount
    ]);
    ...
    _amount
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as IDDAIContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('burn(address,address)', [_receiver,
    _amount
    ]);
        ...
        _amount
            ...
            const abiEncoder = self._lookupAbiEncoder('burn(address,address)');
    ...
    public  = {
        async sendTransactionAsync(
            ...
            const self = this as any as IDDAIContract;
            const encodedData = self._strictEncodeArguments('mint(address,address)', [_receiver,
    _amount
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
    ...
    _amount
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as IDDAIContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('mint(address,address)', [_receiver,
    _amount
    ]);
            return abiEncodedTransactionData;
        },
        ...
        _amount
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('mint(address,address)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<BigNumber
        >(rawCallResult);
            // tslint:enable boolean-naming

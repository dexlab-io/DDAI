...
export class IMakerFeedContract extends BaseContract {
    public read = {
        /**
        ...
        > {
            ...
            const self = this as any as IMakerFeedContract;
...
public static async deployFrom0xArtifactAsync(
        ...
        return IMakerFeedContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`IMakerFeed successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new IMakerFeedContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: { [contractName: string]: ContractAbi }) {
        super('IMakerFeed', IMakerFeedContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies);

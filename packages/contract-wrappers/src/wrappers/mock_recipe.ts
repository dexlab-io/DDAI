...
export class MockRecipeContract extends BaseContract {
    public tokensReceived = {
        ...
        txData?: Partial<TxData> | undefined,
            ...
            const self = this as any as MockRecipeContract;
    ...
    public to = {
        ...
        > {
            ...
            const self = this as any as MockRecipeContract;
            const encodedData = self._strictEncodeArguments('to()', []);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
                    ...callData,
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('to()');
            // tslint:disable boolean-naming
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as MockRecipeContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('to()', []);
            return abiEncodedTransactionData;
        },
        /**
         * Decode the ABI-encoded transaction data into its input arguments
    ...
    public operatorData = {
        ...
        > {
            ...
            const self = this as any as MockRecipeContract;
            const encodedData = self._strictEncodeArguments('operatorData()', []);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
                    ...callData,
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('operatorData()');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<string
        >(rawCallResult);
            // tslint:enable boolean-naming
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as MockRecipeContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('operatorData()', []);
            return abiEncodedTransactionData;
        },
        /**
         * Decode the ABI-encoded transaction data into its input arguments
    ...
    public amount = {
        ...
        > {
            ...
            const self = this as any as MockRecipeContract;
            const encodedData = self._strictEncodeArguments('amount()', []);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
                    ...callData,
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('amount()');
            // tslint:disable boolean-naming
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as MockRecipeContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('amount()', []);
            return abiEncodedTransactionData;
        },
        /**
         * Decode the ABI-encoded transaction data into its input arguments
    ...
    public userData = {
        ...
        > {
            ...
            const self = this as any as MockRecipeContract;
            const encodedData = self._strictEncodeArguments('userData()', []);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
                    ...callData,
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('userData()');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<string
        >(rawCallResult);
            // tslint:enable boolean-naming
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as MockRecipeContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('userData()', []);
            return abiEncodedTransactionData;
        },
        /**
         * Decode the ABI-encoded transaction data into its input arguments
    ...
    public from = {
        ...
        > {
            ...
            const self = this as any as MockRecipeContract;
            const encodedData = self._strictEncodeArguments('from()', []);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                    to: self.address,
                    ...callData,
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('from()');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<string
        >(rawCallResult);
            // tslint:enable boolean-naming
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as MockRecipeContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('from()', []);
            return abiEncodedTransactionData;
        },
        /**
         * Decode the ABI-encoded transaction data into its input arguments
...
public static async deployFrom0xArtifactAsync(
        ...
        return MockRecipeContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _token,
_underlying
);
    }
...
_underlying
        ...
        logUtils.log(`MockRecipe successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new MockRecipeContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
...
_underlying
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: { [contractName: string]: ContractAbi }) {
        super('MockRecipe', MockRecipeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies);

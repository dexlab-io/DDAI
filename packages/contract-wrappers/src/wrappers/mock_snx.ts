...
export class MockSnxContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return MockSnxContract.deployAsync(bytecode, abi, provider, txDefaults, );
    }
    public static async deployAsync(
        ...
        const contractInstance = new MockSnxContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
        contractInstance.constructorArgs = [];
        return contractInstance;
    }
    constructor(abi: ContractAbi, address: string, provider: Provider, txDefaults?: Partial<TxData>) {
        super('MockSnx', abi, address, provider, txDefaults);

...
export type MockSnxEventArgs =
    | MockSnxTransferEventArgs
    | MockSnxApprovalEventArgs;

export enum MockSnxEvents {
    Transfer = 'Transfer',
    Approval = 'Approval',
}

export interface MockSnxTransferEventArgs extends DecodedLogArgs {
    from: string;
    to: string;
    value: BigNumber;
}

export interface MockSnxApprovalEventArgs extends DecodedLogArgs {
    owner: string;
    spender: string;
    value: BigNumber;
}
...
export class MockSnxContract extends BaseContract {
    public approve = {
        /**
        ...
        txData?: Partial<TxData> | undefined,
            ...
            const self = this as any as MockSnxContract;
...
private readonly _subscriptionManager: SubscriptionManager<MockSnxEventArgs, MockSnxEvents>;
public static async deployFrom0xArtifactAsync(
        artifact: ContractArtifact | SimpleContractArtifact,
        supportedProvider: SupportedProvider,
        txDefaults: Partial<TxData>,
        logDecodeDependencies: { [contractName: string]: (ContractArtifact | SimpleContractArtifact) },
    ): Promise<MockSnxContract> {
        ...
        return MockSnxContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`MockSnx successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new MockSnxContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
    ...
    /**
     * Subscribe to an event type emitted by the MockSnx contract.
     * @param eventName The MockSnx contract event you would like to subscribe to.
     ...
     */
    public subscribe<ArgsType extends MockSnxEventArgs>(
        eventName: MockSnxEvents,
        indexFilterValues: IndexedFilterValues,
        callback: EventCallback<ArgsType>,
        isVerbose: boolean = false,
        blockPollingIntervalMs?: number,
    ): string {
        assert.doesBelongToStringEnum('eventName', eventName, MockSnxEvents);
     ...
     */
    public async getLogsAsync<ArgsType extends MockSnxEventArgs>(
        eventName: MockSnxEvents,
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: { [contractName: string]: ContractAbi }) {
        super('MockSnx', MockSnxContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies);
        classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new SubscriptionManager<MockSnxEventArgs, MockSnxEvents>(
            MockSnxContract.ABI(),
            this._web3Wrapper,
        );
    }

...
private readonly _subscriptionManager: SubscriptionManager<MockTokenEventArgs, MockTokenEvents>;
public static async deployFrom0xArtifactAsync(
        ...
        return MockTokenContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, );
    }
    public static async deployAsync(
        ...
        logUtils.log(`MockToken successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new MockTokenContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
    ...
    /**
     * Subscribe to an event type emitted by the MockToken contract.
     * @param eventName The MockToken contract event you would like to subscribe to.
     ...
     */
    public subscribe<ArgsType extends MockTokenEventArgs>(
        eventName: MockTokenEvents,
        indexFilterValues: IndexedFilterValues,
        callback: EventCallback<ArgsType>,
        isVerbose: boolean = false,
        blockPollingIntervalMs?: number,
    ): string {
        assert.doesBelongToStringEnum('eventName', eventName, MockTokenEvents);
     ...
     */
    public async getLogsAsync<ArgsType extends MockTokenEventArgs>(
        eventName: MockTokenEvents,
    ...
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: { [contractName: string]: ContractAbi }) {
        super('MockToken', MockTokenContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies);
        classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new SubscriptionManager<MockTokenEventArgs, MockTokenEvents>(
            MockTokenContract.ABI(),
            this._web3Wrapper,
        );
    }

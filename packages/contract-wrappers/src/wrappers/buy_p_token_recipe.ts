...
export class BuyPTokenRecipeContract extends BaseContract {
    ...
    public static async deployFrom0xArtifactAsync(
        ...
        return BuyPTokenRecipeContract.deployAsync(bytecode, abi, provider, txDefaults, _token,
_underlying
);
    }
...
_underlying
        ...
        const contractInstance = new BuyPTokenRecipeContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
...
_underlying
    ...
    constructor(abi: ContractAbi, address: string, provider: Provider, txDefaults?: Partial<TxData>) {
        super('BuyPTokenRecipe', abi, address, provider, txDefaults);

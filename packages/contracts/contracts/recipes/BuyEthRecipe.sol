...
contract BuyEthRecipe {
    ...
    address constant internal ETH_TOKEN_ADDRESS = ERC20(0x00eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee);
    ...
    function tokensReceived(
        ...
        kyberNetwork.trade(address(underlying), _amount, ETH_TOKEN_ADDRESS, _from, uint256(-1), 0, address(0));
    }
}